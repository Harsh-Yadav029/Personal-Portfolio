    ...
    <section id="hero" className="relative min-h-screen w-full flex flex-col items-center justify-center pt-20 pb-8 px-8 overflow-visible">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto">
        ...
        >
          ...
          {/* Divider */}
          <div className="hero-divider" style={{ width: 1, height: 36, background: "rgba(255,255,255,0.08)", margin: "0 4px" }} />
      ...
      <style>{`
        @media (max-width: 768px) {
          #hero { padding: 6rem 1.5rem 4rem 1.5rem !important; }
          .hero-divider { display: none !important; }
          .hero-actions { flex-direction: column !important; align-items: flex-start !important; gap: 2rem !important; }
        }
      `}</style>
